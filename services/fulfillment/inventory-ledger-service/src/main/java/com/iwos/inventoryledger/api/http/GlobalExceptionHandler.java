...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleStockNotFound(InventoryStockNotFoundException exception) {
    ...
    public ResponseEntity<ApiErrorResponse> handleReservationNotFound(InventoryReservationNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error(
    ...
    public ResponseEntity<ApiErrorResponse> handleReservationStateConflict(ReservationStateConflictException exception) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(error(
