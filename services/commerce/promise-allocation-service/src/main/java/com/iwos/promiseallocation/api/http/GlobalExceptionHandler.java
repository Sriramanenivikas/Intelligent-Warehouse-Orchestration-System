...
import com.iwos.promiseallocation.infrastructure.inventory.InventoryLookupException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PromiseEvaluationNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleEvaluationNotFound(PromiseEvaluationNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error(
                "PROMISE_EVALUATION_NOT_FOUND",
                exception.getMessage(),
                Map.of()
        ));
    }

    @ExceptionHandler(InventoryLookupException.class)
    public ResponseEntity<ApiErrorResponse> handleInventoryLookupFailure(InventoryLookupException exception) {
